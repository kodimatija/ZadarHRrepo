...
Q1BiYXNl = base64.b64decode('aHR0cDovL2tvZGliYWxrYW4uY29tL0lQVFZST0JJTkhPT0QvVHZCYWxrYW5NZW51LnhtbA==')

addon = xbmcaddon.Addon('plugin.video.RobinHoodTv')
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.live.Tojelako]: %s" %(addon_version, string))
