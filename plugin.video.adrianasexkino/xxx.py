...
o0OO00 = 'plugin.video.adrianasexkino'
oi1000 = 'plugin.video.xxxmenu'
oo = Addon ( o0OO00 , sys . argv )
i1iII1IiiIiI1 = xbmcaddon . Addon ( id = o0OO00 )
iIiiiI1IiI1I1 = '[COLOR blue][B]Sexuria[/B][/COLOR]'
iIiiiI1IiI1I2 = '[COLOR blue][B]XXX MENU[/B][/COLOR]'
o0OoOoOO00 = os . path . join ( os . path . join ( xbmc . translatePath ( 'special://home' ) , 'addons' ) , 'plugin.video.adrianasexkino' )
...
iIiiiI = xbmc . translatePath ( os . path . join ( 'special://home/userdata/addon_data/plugin.video.xxxmenu/downloads/' ) )
...
def oOO ( url , mode , name , iconimage , fanart ) :
 ...
 with open ( I1IiI , "a" ) as I1Ii :
  ...
  iI111iI . notification ( iIiiiI1IiI1I1 , '[COLOR blue]' + name + ' added to favourites[/COLOR]' , 'https://img1.picload.org/image/dlgcwgir/icon.png' , 5000 )
...
def O0o0Oo ( ) :
 ...
 with open ( I1IiI , "w" ) as I1Ii :
  I1Ii . write ( '' )
  iI111iI . notification ( iIiiiI1IiI1I2 , '[COLOR blue]Favourites has been wiped[/COLOR]' , 'https://img1.picload.org/image/dlgcwgir/icon.png' , 5000 )
...
def o0o0oOOOo0oo ( ) :
 ...
 I11II1i ( "[COLOR white][B]M[COLOR blue]enu[/B][/COLOR]" , 'null' , 2 , 'https://img3.picload.org/image/dlgcaigi/home.png' , I11i , '[COLOR blue]Back to XXX Menu[/COLOR]' )
...
def i1I1iI ( url ) :
 ...
 OOooO0OOoo ( "[COLOR red]" + "EMERGENCY EXIT" + "[/COLOR]" , 'url1' , 911 , 'https://img3.picload.org/image/dlgcaira/x.png' , I11i , '[COLOR red]EMERGENCY EXIT[/COLOR]' )
 if 'null' in url :
  xbmc.executebuiltin('RunAddon(plugin.video.xxxmenu)')
def Ii1iIiii1 ( url ) :
