...
def syncTraktLibrary():
    control.execute(
        'RunPlugin(plugin://%s)' % 'plugin.video.samoborfilm/?action=tvshowsToLibrarySilent&url=traktcollection')
    control.execute(
        'RunPlugin(plugin://%s)' % 'plugin.video.samoborfilm/?action=moviesToLibrarySilent&url=traktcollection')

try:
    ModuleVersion = control.addon('script.module.samoborfilm').getAddonInfo('version')
    AddonVersion = control.addon('plugin.video.samoborfilm').getAddonInfo('version')
